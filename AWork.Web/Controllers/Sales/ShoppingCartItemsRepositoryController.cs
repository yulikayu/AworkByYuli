...
{
    public class ShoppingCartItemsRepositoryController : Controller
    {
        //private readonly AdventureWorks2019Context _context;
        private readonly ISalesRepositoryManager _context;

        public ShoppingCartItemsRepositoryController(ISalesRepositoryManager context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.ShoppingCartItemRepository.GetAllShoppingCartItem(false));
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var shoppingCartItem = await _context.ShoppingCartItemRepository.GetShoppingCartItemById((int)id, false);
        ...
        public async Task<IActionResult> Create([Bind("ShoppingCartItemId,ShoppingCartId,Quantity,ProductId,DateCreated,ModifiedDate")] ShoppingCartItem shoppingCartItem)
        {
            if (ModelState.IsValid)
            {
                ...
                _context.ShoppingCartItemRepository.Insert(shoppingCartItem);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var shoppingCartItem = await _context.ShoppingCartItemRepository.GetShoppingCartItemById((int)id, true);
            if (shoppingCartItem == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ShoppingCartItemId,ShoppingCartId,Quantity,ProductId,DateCreated,ModifiedDate")] ShoppingCartItem shoppingCartItem)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();*/
                    _context.ShoppingCartItemRepository.Edit(shoppingCartItem);
                    await _context.SaveAsync();
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();*/
            var shoppingCartItem = await _context.ShoppingCartItemRepository.GetShoppingCartItemById((int)id, false);
            _context.ShoppingCartItemRepository.Remove(shoppingCartItem);
            await _context.SaveAsync();
            return RedirectToAction(nameof(Index));
        }
